...
if(isset($_POST['insert']))
{
    ...
    $price=$_POST['price'];
    $sql4="update products set CategoryName=:category,ProductName=:product,ProductPrice=:price where id=:eib";
...
<div class="card-body">
    <?php
    $eid=$_POST['edit_id4'];
    $sql2="SELECT products.id,products.CategoryName,products.ProductName,products.PostingDate,products.ProductPrice,products.ProductImage from products where products.id=:eid";
    ...
    if($query2->rowCount() > 0)
    {
        foreach($results as $row)
        {
            ...
            <h4 style="color: blue">Edit Product Details</h4>
                <div class="control-group">
                    <label class="control-label" for="basicinput">Product Image</label>
                    <div class="controls">
                        <img style="height: 100px; width: 100px;" src="../chattels/images/products/<?php  echo $row->ProductImage;?>" width="150" height="100">
